    ...
    <SafeAreaView>
      ...
      <ScrollView>
        ...
        <Dropdown 
          ...
          valueField="value"
          value={form.gender}
          onChange = {(item: any) => {setForm(prev => ({...prev, gender: item.value}))}}
        />
        ...
        <Dropdown
          ...
          value={form.program}
          onChange={(item: any) => {setForm(prev => ({ ...prev, program: item.value }))}}
        />

        <TouchableOpacity className="bg-black rounded w-[30vw]" onPress={() => userId && updateProfile(userId, form)}>
